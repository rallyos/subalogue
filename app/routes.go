...
func (s *Server) routes() {
	...
	s.Router.HandleFunc("/api/v1/me/subscriptions/{id:[0-9]+}", subscriptions.Update).Methods(http.MethodPut)
	s.Router.HandleFunc("/api/v1/me/subscriptions/{id:[0-9]+}", subscriptions.Delete).Methods(http.MethodDelete)
